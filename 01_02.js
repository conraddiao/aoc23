const data = `kjrqmzv9mmtxhgvsevenhvq7
...
const test2 = `eighthree`;

function switchNumber(foo) {
    switch (foo) {
        case 'one':
            return '1'
        case 'two':
...
function advent(txt) {
    ...
    const values = lines.map((line) => {
        ...
        return Number(switchNumber(first[1])+switchNumber(last[1]))
    });
